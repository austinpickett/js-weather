...
(function() {
  var babelify, browserify, buffer, buildScript, cssmin, fileinclude, gulp, gutil, handleErrors, livereload, notify, sass, sequence, source, sourcemaps, uglify, watchify;
  ...
  gulp.task('default', function() {
    return sequence('js', 'sass', 'html', 'images', 'server', function() {
      buildScript(true);
